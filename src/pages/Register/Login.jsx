    ...
    return (
        ...
        >
            ...
            <Box
                sx={{
                    position: "absolute",
                    left: { xs: "-90px", sm: "-110px", md: "-120px", lg: "-140px", xl: "-160px" },
                    bottom: { xs: "-90px", sm: "-110px", md: "-120px", lg: "-140px", xl: "-160px" },
            ...
            <Box
                sx={{
                    position: "absolute",
                    right: { xs: "-90px", sm: "-110px", md: "-120px", lg: "-140px", xl: "-160px" },
                    top: { xs: "-90px", sm: "-110px", md: "-120px", lg: "-140px", xl: "-160px" },
                    width: { xs: 160, sm: 240, md: 350, lg: 420, xl: 480 },
                    height: { xs: 160, sm: 240, md: 350, lg: 420, xl: 480 },
                    borderRadius: "50%",
                    background: "linear-gradient(135deg,#d500f9,#7c4dff)",
            ...
            <Paper
                sx={{
                    width: "100%",
                    maxWidth: { xs: "100%", sm: "520px", md: "850px", lg: "1000px", xl: "1100px" },
            ...
            >
                ...
                >
                    <Box
                        ...
                        sx={{
                            ...
                            maxWidth: { xs: "220px", sm: "320px", md: "360px", lg: "400px", xl: "440px" },
                            transition: "0.4s",
                            "&:hover": {
                ...
                >
                    <Typography
                        ...
                        fontWeight="bold"
                        sx={{
                            fontSize: { xs: "28px", sm: "34px", md: "40px", lg: "44px", xl: "48px" },
                            mb: 1,
                        }}
                    >
                        LOGIN
